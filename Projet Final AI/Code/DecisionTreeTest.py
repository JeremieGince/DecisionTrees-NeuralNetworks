...
if __name__ == '__main__':
    ...
    cielFeature = Feature(0, data[:, [0, -1]], label="ciel")
    ...
    temperatureFeature = Feature(1, data[:, [1, -1]], label="Température")
    ...
    humiditeFeature = Feature(2, data[:, [2, -1]], label="Humidité")
    ...
    ventFeature = Feature(3, data[:, [3, -1]], label="Vent")
